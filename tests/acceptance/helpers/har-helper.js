/*
    Based on https://github.com/Everettss/puppeteer-har
    This helper allows us to record the network (all of the requests and responses) 
    from chromium while the tests run.
...
class PuppeteerHarHelper extends Helper {
  /**
   * @param {object} page
   */
  constructor(page) {
   ...
   * @return {Promise<void>}
   */
  async startHarRecording({ path, saveResponse, captureMimeTypes } = {}) {
...
module.exports = PuppeteerHarHelper;
